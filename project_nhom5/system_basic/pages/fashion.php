...
<body>
    ...
    <div class="centent">
        <div class="centent-ct ct-ct1">
            ...
            <li><a href="#newborn">Newborn Clothes</a><br></li>
            <li><a href="#girl-fashion">Girl Fashion</a><br></li>
            <li><a href="#boy-fashion">Boy Fashion</a><br></li>
            <li><a href="#baby-shoes">Baby Shoes</a><br></li>
            <li><a href="#accessory">Accessory</a><br></li>
        ...
        <div class="centent-ct">
            <h4 id="newborn">Newborn clothes</h4>
                <div class="shop-product-wrap grid-view row">
                    <?php        
                            $sql = "SELECT products.*,brand.id as brand_id,brand.brand_name FROM products INNER JOIN brand ON products.brand_id = brand.id where brand.id = 4";
                            $res = $conn->query($sql); 
            ...
            <h4 id="girl-fashion">Girl fashion</h4>
                <div class="shop-product-wrap grid-view row">
                        <?php        
                                $sql = "SELECT products.*,brand.id as brand_id,brand.brand_name FROM products INNER JOIN brand ON products.brand_id = brand.id where brand.id = 5";
                                $res = $conn->query($sql); 
                                while ($row = $res->fetch_array()) {
                                    // echo "<pre>";
                                    // var_dump($row);     exit();              
            ...
            <h4 id="boy-fashion">Boy fashion</h4>
            <div class="shop-product-wrap grid-view row">
                    <?php        
                                $sql = "SELECT products.*,brand.id as brand_id,brand.brand_name FROM products INNER JOIN brand ON products.brand_id = brand.id where brand.id = 6";
                                $res = $conn->query($sql); 
                                while ($row = $res->fetch_array()) {
                                    // echo "<pre>";
                                    // var_dump($row);     exit();              
            ...
            <h4 id="baby-shoes">Baby shoes</h4>
            <div class="shop-product-wrap grid-view row">
                    <?php        
                            $sql = "SELECT products.*,brand.id as brand_id,brand.brand_name FROM products INNER JOIN brand ON products.brand_id = brand.id where brand.id = 7";
                            $res = $conn->query($sql); 
                            while ($row = $res->fetch_array()) {
                                // echo "<pre>";
                                // var_dump($row);     exit();              
            ...
            <h4 id="accessory">Accessory</h4>
            <div class="shop-product-wrap grid-view row">
                <?php        
                        $sql = "SELECT products.*,brand.id as brand_id,brand.brand_name FROM products INNER JOIN brand ON products.brand_id = brand.id where brand.id = 8";
                        $res = $conn->query($sql); 
                        while ($row = $res->fetch_array()) {         
                ?>
                <div class="col-md-4 col-sm-6">
