...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="?view=list-order">ADMIN</a></div>
            <div class="nav-right ">
                ...
                <div class="btn-group">
                    <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Xin chào
                        <?php 
                            if(isset($_SESSION['user_login_admin'])){
                                echo $_SESSION['user_login_admin'];
                            }
                        ?>
                    </button>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="?view=logout">Thoát</a>
                    </div>
                </div>
            </div>
        </nav>
